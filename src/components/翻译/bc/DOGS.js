const translation = {
    ...
    // 其他设置
    "删除 local messages after delay": "延迟后删除本地消息",
    ...
    // 恶作剧锁说明
    "The padlock is made in such a way that the wearer": "这种锁的特殊设计使佩戴者",
    "cannot remove it on their own. In the padlock": "无法自行解开。在锁的",
