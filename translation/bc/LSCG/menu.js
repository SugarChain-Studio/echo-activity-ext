...
const translation = {
    ...
    "Applies a more restrictive set of conditional states while incapacitated by LSCG.": "当因 LSCG 效果丧失行动能力时，启用更严格的状态限制",
    "Blur While Edged:": "边缘控制视觉模糊:",
    "Apply extra blurring to the screen while edging.": "处于边缘控制状态时增加屏幕模糊效果",
    "Enable Lipstick Marks:": "启用唇印效果:",
    "Apply kiss marks when lipstick-wearing people kiss you on the cheek/forehead/neck.": "当涂有口红的角色亲吻你的脸颊/前额/颈部时显示唇印",
    "Dry Lipstick:": "防止留下唇印:",
    ...
    "If enabled, will display the attacker/defender roll values for activity checks.": "启用后将显示活动判定中的攻击方/防御方掷骰数值",
    "Share Public Craftings:": "公开自制物品:",
    "If enabled, other LSCG users in the room will be able to use your crafted items on other people.": "启用后，同房间的其他 LSCG 用户可使用你制作的物品",
    "Hide Resizing Effects:": "隐藏尺寸变化效果:",
    "If checked, you will not see any LSCG resizing effects. (eg. from magic)": "勾选后将隐藏所有尺寸变化特效（如魔法效果）",
    "Hide all Opacity Overrides:": "隐藏透明度特效:",
    "If checked, will skip any opacity override effects. (includes x-ray vision)": "勾选后将禁用所有透明度覆盖效果（包括透视视觉）",
    "Prevent Remote Opacity Changes:": "禁止远程修改透明度:",
    "If checked, other players will not be able to directly modify the opacity settings on your wardrobe items.": "勾选后其他玩家无法直接调整你服装的透明度设置",
    "Enable Clothed Erection Detection:": "启用衣物下勃起检测:",
    "If checked, you will get a private message if you can feel an erection during certain activities.": "勾选后，特定活动中感知到勃起时将收到私密提示",
    "Allow LSCG Leashing:": "允许束缚互动:",
    "Allow custom leashing from LSCG activities such as hand-holding, hypnosis, etc.": "允许通过牵手、催眠等 LSCG 互动建立束缚关系",
    ...
    "If enabled, your trigger word will be selected from a list of random english words.": "启用后将从随机英文词库中选取触发词",
    "Trigger Words:": "催眠触发词:",
    "Custom list of words and/or phrases as hypnisis triggers. Separated by a comma.": "自定义催眠触发词/短语列表（逗号分隔）",
    "Awaken Words:": "唤醒指令:",
    "Custom list of words and/or phrases as awakener triggers. Separated by a comma.": "自定义唤醒触发词/短语列表（逗号分隔）",
    "Silence Trigger Words:": "禁言指令:",
    "When spoken while hypnotized, will prevent speech. Separated by a comma.": "催眠状态下说出时将禁止发言（逗号分隔）",
    ...
    "Comma separated list of member IDs exclusive allowed to access your hypno settings and triggers. If empty will use standard Item Permissions.": "可操作催眠设置的成员ID列表（逗号分隔，留空则使用物品默认权限）",
    "Hypnosis Length (min.):": "催眠持续时间(分钟):",
    "Length of hypnosis time (in minutes) before automatically recovering. Set to 0 for indefinite.": "自动苏醒前的催眠时长（0为永久）",
    "Cooldown (sec.):": "抗性周期(秒):",
    "Cooldown time (in seconds) before you can be hypnotized again.": "再次接受催眠所需间隔时间",
    "Enable Cycle:": "启用指令轮替:",
    "If checked, only one trigger will be active at a time and will cycle after use.": "启用后每次仅激活一个触发指令，使用后自动轮换",
    ...
    "If checked, only the user who hypnotized you can access your settings (after matching other conditions).": "仅当前催眠者满足条件后可操控设置",
    "Allow Remote Override Member Modification:": "开放成员列表编辑权限:",
    "If checked, any remote users can change your Override Member Id list (otherwise, only owner can).": "允许所有远程用户修改成员覆盖列表（否则仅限所有者）",
    "Lockable:": "可锁定设置:",
    ...
    "Hex code of your eye color while hypnotized (default: #A2A2A2).": "催眠状态下的瞳孔色值（十六进制，默认：#A2A2A2）",
    ...
    "If checked, only your hypnotizer may induce hypnotic suggestions within you.": "勾选后，只有你的催眠者可以对你植入催眠暗示",
    "Programming Limited to Hypnotizer": "仅限催眠者植入",
    "If checked, hypnotic suggestions may be induced within you while under trance.": "勾选后，在催眠状态下可被植入暗示",
    "Allow Suggestion Removal": "允许移除暗示",
    "If checked, you can remove suggestions installed in you with '/lscg remove-suggestion' if you are not immersive and not on extreme difficulty.": "勾选后，若非沉浸模式且非极端难度，可使用指令'/lscg remove-suggestion'移除已植入的暗示",
    ...
    "Comma separated list of member IDs. If empty will use standard Item Permissions. You will always submit to their suggestions.": "逗号分隔的成员ID列表（留空则使用默认物品权限），将绝对服从这些成员的暗示",
    ...
    "Enables breathplay using \"Choke Neck\" activity. If done repeatedly will cause blackout.": "启用\"颈部窒息\"活动进行窒息玩法，反复操作可能导致昏迷",
    ...
    "Act now and secure your Control Module now for the low low price of $500!": "立即抢购！现在仅需500美元即可拥有这款控制模块！",
    "Attach this revolutionary new device to your existing collar and it will": "将这款革命性设备与现有项圈连接后，即可",
    "enhance it with the ability to tighten and loosen on command!": "实现智能收放控制功能！",
    "Let your dom quiet down those bratty moments and reward good behavior!": "让您的主人轻松管教任性时刻，及时奖励乖巧表现！",
    ...
    "Comma separated list of member IDs who can activate the collar. Leave empty for item permissions.": "可激活项圈的成员ID列表（逗号分隔，留空则遵循物品默认权限）",
    "Limit to Crafted User:": "限定制作者使用:",
    "Limits collar activation to crafted user and allowed list. If no crafted user will use item permissions.": "仅限物品制作者及授权列表可使用（无制作者时遵循物品权限）",
    ...
    "Allows activation of the collar features via buttons (activities & commands).": "允许通过快捷按钮（活动与指令）激活项圈功能",
    "Any Collar:": "通用适配模式:",
    ...
    "Activates for any injector or drink with \"horny\" or \"aphrodisiac\" in its crafted name or description.": "对名称或描述中含\"催情\"或\"媚药\"的注射器/饮品生效",
    "Enable Brainwash Drug:": "启用洗脑药物效果:",
    "Activates for any injector or drink with \"mind control,\" \"hypnotizing,\" or \"brainwashing\" in its crafted name or description.": "对名称或描述中含\"精神控制\"、\"催眠\"或\"洗脑\"的注射器/饮品生效",
    "Enable Aphrodisiac:": "启用催情剂效果:",
    "Activates for any injector or drink with \"sedative\" or \"tranquilizer\" in its crafted name or description.": "对名称或描述中含\"镇静\"或\"安定\"的注射器/饮品生效",
    ...
    "If true, will allow respirators to deliver a continuous supply of drugged gas.": "启用后，呼吸器将持续释放麻醉气体",
    "Inexhaustible Gases:": "无限气体供应:",
    "If true, any continuous delivery (eg. respirator) on you will never run out of gas.": "启用后，持续供气设备（如呼吸器）将不会耗尽",
    ...
    "If true, enables an occasional heartbeat sound while under the influence of aphrodisiac.": "催情剂生效期间将播放间歇性心跳声",
    "Chaotic Net Gun:": "混乱模式网枪:",
    "If true, your net gun will fire wildly and have a 50/50 chance to net a random character instead of your target.": "启用后网枪将随机发射，50%概率捕获非目标角色",

    // 药物强化效果第二页
    "Enable Chloroform:": "启用氯仿麻醉:",
    "Fall asleep if chloroformed.": "被氯仿药棉麻醉时将陷入昏睡",
    "Chloroform Never Fades:": "氯仿效果永续:",
    "If enabled one rag over your mouth will last forever until removed, otherwise its potency will fade after an hour.": "启用后，覆盖口部的药棉将永久有效（需手动移除），否则药效将在1小时后消退",
    ...
    "Number times within 5 minutes this activity must be done before hypnosis or sleep is triggered.": "5分钟内需重复该互动次数方可触发催眠/睡眠效果",
    "Trance Arousal Threshold": "催眠触发敏感度",
    "Arousal threshold required for this activity to trigger hypnosis. If both trance and sleep are checked, lower arousal triggers sleep.": "触发催眠所需敏感度阈值（若同时启用催眠与睡眠，较低敏感度将触发睡眠）",
    "Can Awaken": "可解除状态",
    "Using this activity on this location will awaken you from trance or deep sleep.": "在该部位进行此互动可解除催眠/深度睡眠状态",
    ...
    "Member IDs who can trance/sleep/awaken/orgasm with this activity. Leave empty to use BC item permissions": "可使用此互动进行催眠/睡眠/唤醒/高潮操作的成员ID（留空则遵循BC物品默认权限）",
    ...
    "With just a simple signature you too can experience the thrill of Magic™!": "只需轻轻签名，即刻体验魔法™的非凡魅力！",
    ...
    "* Signatory agrees to Magic™ Installation (ᴘᴀᴛ. ᴘᴇɴᴅ.) required to experience spell effects *": "*签署即视为同意魔法™契约（专利认证中），方可施展法术*",

    // 魔法第一页
    // "Triggered Hypnosis": "指令触发式催眠",
    "Enabled the use and application of Magic™.": "激活魔法™系统",
    "Enable Wild Magic:": "启用混沌魔法:",
    "Cast a random spell from your spell list, with a chance of a truly random spell.": "从已知法术中随机施放，有小概率触发未知混沌法术",
    ...
    "Casting Phrase:": "咒文吟诵:",
    "Phrase/word to cast your spell by typing <Casting phrase> <target Name> in the chat.": "在聊天栏输入<咒文> <目标名>即可施放",
    "Allow Potion:": "可调制魔药:",
    "Allows this spell to be brewed into a crafted potion bottles/glasses/mugs using its name.": "允许将此法术转化为同名魔药（可装入各类容器）",
    ...
    "Comma separated list of member IDs. If empty will use standard Item Permissions.": "逗号分隔的成员ID列表（留空则遵循物品默认权限）",
    "Never Defend:": "完全放弃抵抗:",
    "If checked, you will never defend against spells cast on you.": "启用后将完全不对任何法术效果进行抵抗",
    "Defenseless Against Member IDs:": "特定成员豁免抵抗:",
    "Comma separated list of member IDs. If empty will use standard Item Permissions. You will never defend against their spells.": "指定成员ID列表（留空则遵循物品权限），对其法术将完全不进行抵抗",
    "Limited Spell Duration:": "法术时效限制:",
    "If checked, you will eventually break free from a detrimental spell's effects, the time variable based on how poorly you fail an activity roll against the caster.": "启用后可根据对抗检定失败程度，逐步解除负面法术效果",
    "Maximum Spell Duration:": "法术最大持续时间:",
    "Maximum amount of time, in minutes, you will be affected by any specific spell effects. Set to 0 for no maximum.": "单个法术效果最长持续时间（分钟，0为无限制）",
    ...
    "If checked, only people on your whitelist can cast spells on you or teach you spells.": "启用后仅白名单成员可对你施法或传授法术",
    ...
    "Dispell": "驱散术",
    "Dispells any existing effects on the target (including anything drug induced).": "解除目标所有状态效果(含药物影响)",
    "X-Ray Vision": "透视之眼",
    ...
    "If enabled, the user will only be able to control where splatter is applied if unrestrained.": "被束缚时将失去对飞溅位置的控制权",
    "Lovers Only:": "仅限亲密对象:",
    "If enabled, only your lovers and whitelist will be able to apply splatters to you.": "仅允许亲密关系者及白名单成员使用飞溅效果",
    "Splatter Whitelist:": "飞溅白名单:",
    "Set member numbers who are explicitly allowed to splatter on you. Comma separated list of member IDs.": "指定允许使用飞溅效果的成员ID（逗号分隔）",
    "Splatter Blacklist:": "飞溅黑名单:",
    "Set member numbers who are explicitly blocked from splattering on you. Comma separated list of member IDs.": "指定禁止使用飞溅效果的成员ID（逗号分隔）",
    "Splatter Color Override:": "自定义飞溅颜色:",
    "Override color [hex code] for splatter application. Can comma separate possible values (eg: #FFF, #F0F0F0).": "覆盖默认飞溅颜色（十六进制色码，可多值逗号分隔如：#FFF,#F0F0F0）",
    "Splatter Opacity % Override:": "自定义飞溅透明度:",
    "Override opacity for splatter application. Can comma separate possible values and provide range (eg: 20, 60-70).": "覆盖默认透明度（百分比，可设范围如：20,60-70）",
    ...
    "Maximum amount of time, in minutes, the target will be affected by any specific spell effects. Set to 0 for unlimited.": "目标受法术影响的最长时间(分钟)，设为0表示无限时长",
    "If checked, the target will eventually break free from a detrimental spell's effects, the time variable based on how poorly they fail an activity roll against the caster.": "勾选后，目标会根据对抗施法者检定的失败程度，逐渐解除负面法术效果",
    "If checked, the target will never defend against spells cast on them.": "勾选后，目标将不会抵抗任何对其施放的法术",
    "Comma separated list of member IDs. If empty will use standard Item Permissions. The target will never defend against their spells.": "逗号分隔的成员ID列表（留空则使用物品默认权限），目标不会抵抗这些成员的法术",
